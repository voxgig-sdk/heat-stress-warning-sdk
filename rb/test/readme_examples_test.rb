...
#      offline in seeded test mode (HeatStressWarningSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "HeatStressWarning_sdk.rb")
  SDK_CLASS = "HeatStressWarningSDK"
  ...
  SDK_BASE = "HeatStressWarning_sdk"
