...
class HeatStressWarningTcEntity
  ...
  def make
    opts = @_entopts.dup
    HeatStressWarningTcEntity.new(@_client, opts)
  end
  ...
  #
  # @param reqmatch [HeatStressWarningTcListMatch, Hash, nil] match filter (any subset of
  #   HeatStressWarningTc fields); defaults to nil, treated as an empty match that lists all.
