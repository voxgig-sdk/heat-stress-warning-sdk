...
class HeatStressWarningScEntity
  ...
  def make
    opts = @_entopts.dup
    HeatStressWarningScEntity.new(@_client, opts)
  end
  ...
  # @return [HeatStressWarningSc, Hash] the current HeatStressWarningSc data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of HeatStressWarningSc fields)
  def match_get
  ...
  #
  # @param reqmatch [HeatStressWarningScListMatch, Hash, nil] match filter (any subset of
  #   HeatStressWarningSc fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<HeatStressWarningSc>, Array] the matching HeatStressWarningSc items; raises HeatStressWarningError on failure
