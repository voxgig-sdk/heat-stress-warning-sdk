...
raise a `HeatStressWarningError` (a `StandardError` subclass), so wrap
...
```
rb/
├── HeatStressWarning_sdk.rb       -- Main SDK module
...
The main module (`HeatStressWarning_sdk`) exports the SDK class
