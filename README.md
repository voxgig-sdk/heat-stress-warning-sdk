...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/heat-stress-warning` | `npm install @voxgig-sdk/heat-stress-warning` |
| Python | `voxgig-sdk-heat-stress-warning` | `pip install voxgig-sdk-heat-stress-warning` |
| PHP | `voxgig-sdk/heat-stress-warning` | `composer require voxgig-sdk/heat-stress-warning` |
| Golang | `github.com/voxgig-sdk/heat-stress-warning-sdk/go` | `go get github.com/voxgig-sdk/heat-stress-warning-sdk/go` |
| Ruby | `voxgig-sdk-heat-stress-warning` | `gem install voxgig-sdk-heat-stress-warning` |
| Lua | `voxgig-sdk-heat-stress-warning` | `luarocks install voxgig-sdk-heat-stress-warning` |
