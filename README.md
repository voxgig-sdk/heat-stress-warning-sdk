...
This API provides the latest information regarding heat stress warnings at work in different languages including English, Traditional Chinese, and Simplified Chinese.

Learn more about Heat Stress Warning API at [data.weather.gov.hk/weatherAPI/doc/HSWW_API_Documentation.pdf](https://data.weather.gov.hk/weatherAPI/doc/HSWW_API_Documentation.pdf).
...
$heatstresswarningens = $client->HeatStressWarningEn()->list();
print_r(array_map(fn($item) => $item->data_get(), $heatstresswarningens));
```
