...
type HeatStressWarningSDK struct {
	Mode     string
...
func (sdk *HeatStressWarningSDK) OptionsMap() map[string]any {
...
func (sdk *HeatStressWarningSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *HeatStressWarningSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *HeatStressWarningSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HeatStressWarningSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *HeatStressWarningSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *HeatStressWarningSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("HeatStressWarningSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *HeatStressWarningSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *HeatStressWarningSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("HeatStressWarningSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *HeatStressWarningSDK {
	...
	sdk := NewHeatStressWarningSDK(sdkopts)
	sdk.Mode = "test"
