...
const testSeed = `map[string]any{"entity": map[string]any{"heat_stress_warning_en": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "heat_stress_warning_sc": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "heat_stress_warning_tc": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
