# HeatStressWarning Golang SDK Reference

Complete API reference for the HeatStressWarning Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *HeatStressWarningSDK`
...
#### `HeatStressWarningEn(data map[string]any) HeatStressWarningEntity`

Create a new `HeatStressWarningEn` entity instance. Pass `nil` for no initial data.

#### `HeatStressWarningSc(data map[string]any) HeatStressWarningEntity`

Create a new `HeatStressWarningSc` entity instance. Pass `nil` for no initial data.

#### `HeatStressWarningTc(data map[string]any) HeatStressWarningEntity`
