...
local SDK_MODULE = "heat-stress-warning_sdk"
...
-- data to return.
local TEST_SEED = '{ entity = { ["heat_stress_warning_en"] = { ["test01"] = { id = "test01" } }, ["heat_stress_warning_sc"] = { ["test01"] = { id = "test01" } }, ["heat_stress_warning_tc"] = { ["test01"] = { id = "test01" } } } }'
