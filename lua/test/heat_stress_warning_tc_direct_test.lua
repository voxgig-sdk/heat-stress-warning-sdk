...
describe("HeatStressWarningTcDirect", function()
  it("should direct-list-heat_stress_warning_tc", function()
    local setup = heat_stress_warning_tc_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-heat_stress_warning_tc", setup.live and "live" or "unit")
...
function heat_stress_warning_tc_direct_setup(mockres)
