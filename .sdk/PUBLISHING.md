...
|---|---|---|
| `ts/` | @voxgig-sdk/heat-stress-warning-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/heat-stress-warning-sdk \
      --repository voxgig-sdk/heat-stress-warning-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/heat-stress-warning-sdk` shows it, and
`npm trust revoke @voxgig-sdk/heat-stress-warning-sdk --id=<id>` removes it.
