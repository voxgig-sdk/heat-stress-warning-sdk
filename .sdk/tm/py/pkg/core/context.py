...
from projectname_sdk.core.control import HeatStressWarningControl
...
class HeatStressWarningContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = HeatStressWarningControl()
        ...
        if isinstance(sp, HeatStressWarningSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, HeatStressWarningResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, HeatStressWarningResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return HeatStressWarningOperation({})
    ...
    def make_error(self, code, msg):
        return HeatStressWarningError(code, msg, self)
