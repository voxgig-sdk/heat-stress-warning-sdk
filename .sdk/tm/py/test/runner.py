...
class HeatStressWarningTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = HeatStressWarningTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = HeatStressWarningTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = HeatStressWarningTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
