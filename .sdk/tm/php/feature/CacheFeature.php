...
// HeatStressWarning SDK cache feature
...
class HeatStressWarningCacheFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _through(HeatStressWarningContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
