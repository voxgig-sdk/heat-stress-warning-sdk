...
// HeatStressWarning SDK audit feature
...
class HeatStressWarningAuditFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _emit(HeatStressWarningContext $ctx, string $outcome): void
    {
