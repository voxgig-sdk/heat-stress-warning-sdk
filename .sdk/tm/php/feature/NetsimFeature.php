...
// HeatStressWarning SDK netsim feature
...
class HeatStressWarningNetsimFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _simulate(HeatStressWarningContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(HeatStressWarningContext $ctx, array $applied): void
    {
        $client = $this->client;
