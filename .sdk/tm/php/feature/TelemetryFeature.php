...
// HeatStressWarning SDK telemetry feature
...
class HeatStressWarningTelemetryFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _close(HeatStressWarningContext $ctx, bool $ok): void
    {
