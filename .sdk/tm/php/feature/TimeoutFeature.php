...
// HeatStressWarning SDK timeout feature
...
class HeatStressWarningTimeoutFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _with_timeout(HeatStressWarningContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(HeatStressWarningContext $_ctx, float $ms): void
    {
        $client = $this->client;
