...
// HeatStressWarning SDK utility: graphql
//
...
class HeatStressWarningGraphql
{
    ...
    // equivalent.
    public static function body(HeatStressWarningContext $ctx): mixed
    {
    ...
    public static function errors(HeatStressWarningContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
