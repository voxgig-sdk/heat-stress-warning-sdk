...
// HeatStressWarning SDK utility: make_options

class HeatStressWarningMakeOptions
{
    ...
    public static function call(HeatStressWarningContext $ctx): array
    {
        ...
        //
        // `HeatStressWarningSchema::optspec()` is built from the model:
        ...
        $optspec = HeatStressWarningSchema::optspec();
