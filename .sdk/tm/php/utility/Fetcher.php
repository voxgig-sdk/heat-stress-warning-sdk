...
// HeatStressWarning SDK utility: fetcher

class HeatStressWarningFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; HeatStressWarningSDK/1.0)';
    ...
    public static function call(HeatStressWarningContext $ctx, string $fullurl, array $fetchdef): array
    {
