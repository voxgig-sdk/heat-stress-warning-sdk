...
// HeatStressWarning SDK utility: result_basic

class HeatStressWarningResultBasic
{
    public static function call(HeatStressWarningContext $ctx): ?HeatStressWarningResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof HeatStressWarningError) ? $result->err->msg : (string)$result->err;
