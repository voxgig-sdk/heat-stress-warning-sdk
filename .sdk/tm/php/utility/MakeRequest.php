...
// HeatStressWarning SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class HeatStressWarningMakeRequest
{
    public static function call(HeatStressWarningContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new HeatStressWarningResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new HeatStressWarningResponse($fetched);
        } else {
