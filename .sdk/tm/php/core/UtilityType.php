...
// HeatStressWarning SDK utility type

class HeatStressWarningUtility
{
    ...
    public static function copy(HeatStressWarningUtility $src): HeatStressWarningUtility
    {
        $u = new HeatStressWarningUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
