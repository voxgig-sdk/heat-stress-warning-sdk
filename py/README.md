...
The SDK exposes the API as capitalised, semantic **Entities** — for example `client.HeatStressWarningEn()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/heat-stress-warning-sdk/releases)) or
...
```
py/
├── heatstresswarning_sdk.py         -- Main SDK module
