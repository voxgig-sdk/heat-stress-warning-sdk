# HeatStressWarning SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions HeatStressWarningSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both HeatStressWarningSDK(...) and HeatStressWarningSDK.test(...) become
#      HeatStressWarningSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "heatstresswarning_sdk"
_SDK_CLASS = "HeatStressWarningSDK"
...
_ENTITIES = {
    "HeatStressWarningEn": "heat_stress_warning_en",
    "HeatStressWarningSc": "heat_stress_warning_sc",
    "HeatStressWarningTc": "heat_stress_warning_tc",
}
