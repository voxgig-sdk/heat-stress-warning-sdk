...
from heatstresswarning_sdk.utility import register

# Load features
from heatstresswarning_sdk.feature.base_feature import HeatStressWarningBaseFeature
from heatstresswarning_sdk.features import _has_feature, _make_feature
...
class HeatStressWarningSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = HeatStressWarningUtility()
    ...
    def get_utility(self):
        return HeatStressWarningUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("HeatStressWarningSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def HeatStressWarningEn(self, data=None) -> "HeatStressWarningEnEntity":
        ...
        from heatstresswarning_sdk.entity.heat_stress_warning_en_entity import HeatStressWarningEnEntity
    ...
    def HeatStressWarningSc(self, data=None) -> "HeatStressWarningScEntity":
        ...
        from heatstresswarning_sdk.entity.heat_stress_warning_sc_entity import HeatStressWarningScEntity
    ...
    def HeatStressWarningTc(self, data=None) -> "HeatStressWarningTcEntity":
        ...
        from heatstresswarning_sdk.entity.heat_stress_warning_tc_entity import HeatStressWarningTcEntity
