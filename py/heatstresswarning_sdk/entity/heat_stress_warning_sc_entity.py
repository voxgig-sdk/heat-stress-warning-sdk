...
from heatstresswarning_sdk.heatstresswarning_types import (
    HeatStressWarningSc,
    HeatStressWarningScListMatch,
)
...
class HeatStressWarningScEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HeatStressWarningScEntity(self._client, opts)
    ...
    def data_get(self) -> HeatStressWarningSc:
    ...
    def match_get(self) -> HeatStressWarningSc:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[HeatStressWarningSc]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.HeatStressWarningSc().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
