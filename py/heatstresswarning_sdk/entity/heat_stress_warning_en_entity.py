...
class HeatStressWarningEnEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HeatStressWarningEnEntity(self._client, opts)
    ...
    def data_get(self) -> HeatStressWarningEn:
    ...
    def match_get(self) -> HeatStressWarningEn:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[HeatStressWarningEn]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.HeatStressWarningEn().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
