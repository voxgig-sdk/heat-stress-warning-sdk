...
class HeatStressWarningTcEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return HeatStressWarningTcEntity(self._client, opts)
    ...
    def data_get(self) -> HeatStressWarningTc:
    ...
    def match_get(self) -> HeatStressWarningTc:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[HeatStressWarningTc]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.HeatStressWarningTc().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
