...
AQL-driven CLI and REPL for the HeatStressWarning SDK. Positional arguments are
...
```sh
go build -o heat-stress-warning-cli ./...
```
...
./heat-stress-warning-cli load 1 heat_stress_warning_en
./heat-stress-warning-cli load '{id:1}' heat_stress_warning_en
