...
AQL-driven command-line client **and** interactive REPL for the HeatStressWarning
...
- `<entity>` is a bareword, auto-quoted as an AQL atom (e.g. `heat_stress_warning_en`).
