...
func registerSDKWords(r *eng.Registry, client *sdk.HeatStressWarningSDK) {
...
func runOp(client *sdk.HeatStressWarningSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
