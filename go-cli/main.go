// Command HeatStressWarning-cli is a CLI + REPL for the HeatStressWarning SDK,
...
const prompt = "heat-stress-warning"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "heat_stress_warning_en heat_stress_warning_sc heat_stress_warning_tc"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      HEAT_STRESS_WARNING_APIKEY (api key), HEAT_STRESS_WARNING_BASE (base url override)")
