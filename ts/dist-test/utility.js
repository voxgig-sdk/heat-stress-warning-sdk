...
function envOverride(m) {
    if ('TRUE' === process.env.HEAT_STRESS_WARNING_TEST_LIVE ||
        'TRUE' === process.env.HEAT_STRESS_WARNING_TEST_OVERRIDE) {
    ...
    m.HEAT_STRESS_WARNING_TEST_EXPLAIN = process.env.HEAT_STRESS_WARNING_TEST_EXPLAIN || m.HEAT_STRESS_WARNING_TEST_EXPLAIN;
    return m;
}
