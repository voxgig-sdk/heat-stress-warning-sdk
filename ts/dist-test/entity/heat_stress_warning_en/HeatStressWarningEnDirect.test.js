...
(0, node_test_1.describe)('HeatStressWarningEnDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-heat_stress_warning_en', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-heat_stress_warning_en', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['HEAT_STRESS_WARNING_TEST_HEAT_STRESS_WARNING_EN_ENTID'];
...
//# sourceMappingURL=HeatStressWarningEnDirect.test.js.map