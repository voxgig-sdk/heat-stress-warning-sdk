...
(0, node_test_1.describe)('HeatStressWarningScEntity', async () => {
...
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/heat_stress_warning_sc/HeatStressWarningScTestData.json');
    ...
    let idmap = transform(['heat_stress_warning_sc01', 'heat_stress_warning_sc02', 'heat_stress_warning_sc03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const env = (0, utility_1.envOverride)({
        'HEAT_STRESS_WARNING_TEST_HEAT_STRESS_WARNING_SC_ENTID': idmap,
        'HEAT_STRESS_WARNING_TEST_LIVE': 'FALSE',
        'HEAT_STRESS_WARNING_TEST_EXPLAIN': 'FALSE',
    });
    idmap = env['HEAT_STRESS_WARNING_TEST_HEAT_STRESS_WARNING_SC_ENTID'];
    const live = 'TRUE' === env.HEAT_STRESS_WARNING_TEST_LIVE;
    const transport = (0, live_runner_1.createLiveTransport)();
    if (live) {
        const rawIds = process.env['HEAT_STRESS_WARNING_TEST_HEAT_STRESS_WARNING_SC_ENTID'];
...
//# sourceMappingURL=HeatStressWarningScEntity.test.js.map