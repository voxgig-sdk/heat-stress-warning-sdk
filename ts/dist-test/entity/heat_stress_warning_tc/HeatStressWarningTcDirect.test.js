...
(0, node_test_1.describe)('HeatStressWarningTcDirect', async () => {
    ...
    (0, node_test_1.test)('direct-exists', async () => {
        const sdk = new __1.HeatStressWarningSDK({
    ...
    (0, node_test_1.test)('direct-list-heat_stress_warning_tc', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-heat_stress_warning_tc', setup.live))
            return;
...
function liveScenariosActive() { return false && process.env.HEAT_STRESS_WARNING_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.HeatStressWarningSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
        }));
        let idmap = env['HEAT_STRESS_WARNING_TEST_HEAT_STRESS_WARNING_TC_ENTID'];
    ...
    const client = new __1.HeatStressWarningSDK({
        base: 'http://localhost:8080',
...
//# sourceMappingURL=HeatStressWarningTcDirect.test.js.map