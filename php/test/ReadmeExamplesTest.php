...
// HeatStressWarning SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (HeatStressWarningSDK::test)
...
{
    private const SDK_CLASS = 'HeatStressWarningSDK';
    ...
    private const SDK_BASE = 'heatstresswarning_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../heatstresswarning_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
