...
class HeatStressWarningEnDirectTest extends TestCase
{
    public function test_direct_list_heat_stress_warning_en(): void
    {
        $setup = heat_stress_warning_en_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-heat_stress_warning_en", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
