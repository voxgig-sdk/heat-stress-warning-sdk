...
// HeatStressWarning SDK metrics feature
...
class HeatStressWarningMetricsFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _record(HeatStressWarningContext $ctx, bool $ok): void
    {
