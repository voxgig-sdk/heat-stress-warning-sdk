...
// HeatStressWarning SDK streaming feature
...
class HeatStressWarningStreamingFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _iterate(HeatStressWarningResult $result): \Generator
    {
    ...
    private function _streamable(HeatStressWarningContext $ctx): bool
    {
