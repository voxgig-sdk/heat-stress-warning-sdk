...
// HeatStressWarning SDK paging feature
...
class HeatStressWarningPagingFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _is_list(HeatStressWarningContext $ctx): bool
    {
