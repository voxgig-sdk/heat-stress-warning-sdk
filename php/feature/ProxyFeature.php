...
// HeatStressWarning SDK proxy feature
...
class HeatStressWarningProxyFeature extends HeatStressWarningBaseFeature
{
    ...
    public function init(HeatStressWarningContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (HeatStressWarningContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
