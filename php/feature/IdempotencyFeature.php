...
// HeatStressWarning SDK idempotency feature
...
class HeatStressWarningIdempotencyFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _mutating(HeatStressWarningContext $ctx): bool
    {
