...
// HeatStressWarning SDK rbac feature
...
class HeatStressWarningRbacFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _required(HeatStressWarningContext $ctx): ?string
    {
    ...
    private function _reject(HeatStressWarningContext $ctx, string $required): void
    {
    ...
    private function _track(HeatStressWarningContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
