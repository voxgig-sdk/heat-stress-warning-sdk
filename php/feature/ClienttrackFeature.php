...
// HeatStressWarning SDK clienttrack feature
...
class HeatStressWarningClienttrackFeature extends HeatStressWarningBaseFeature
{
    ...
    public function PostConstruct(HeatStressWarningContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'HeatStressWarning-SDK';
