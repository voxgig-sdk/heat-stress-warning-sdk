...
// HeatStressWarning SDK ratelimit feature
...
class HeatStressWarningRatelimitFeature extends HeatStressWarningBaseFeature
{
    ...
    private function _acquire(HeatStressWarningContext $ctx): void
    {
    ...
    private function _track(HeatStressWarningContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
