...
class HeatStressWarningSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = HeatStressWarningHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = HeatStressWarningHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!HeatStressWarningFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, HeatStressWarningFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return HeatStressWarningUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = HeatStressWarningHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = HeatStressWarningHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = HeatStressWarningHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new HeatStressWarningError($op . "_allow",
                "HeatStressWarningSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = HeatStressWarningHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new HeatStressWarningError("graphql_error",
                "HeatStressWarningSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function HeatStressWarningEn($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_heat_stress_warning_en === null) {
                $this->_heat_stress_warning_en = new HeatStressWarningEnEntity($this, null);
            }
            return $this->_heat_stress_warning_en;
        }
        return new HeatStressWarningEnEntity($this, $data);
    }
    ...
    public function HeatStressWarningSc($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_heat_stress_warning_sc === null) {
                $this->_heat_stress_warning_sc = new HeatStressWarningScEntity($this, null);
            }
            return $this->_heat_stress_warning_sc;
        }
        return new HeatStressWarningScEntity($this, $data);
    }
    ...
    public function HeatStressWarningTc($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_heat_stress_warning_tc === null) {
                $this->_heat_stress_warning_tc = new HeatStressWarningTcEntity($this, null);
            }
            return $this->_heat_stress_warning_tc;
        }
        return new HeatStressWarningTcEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new HeatStressWarningSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
