// Command HeatStressWarning-mcp is an MCP server exposing the HeatStressWarning
// SDK as MCP tools.
//
// Two tools are registered:
//
//	HeatStressWarning_list  — list records of an entity
//	HeatStressWarning_load  — load a single record of an entity
//
